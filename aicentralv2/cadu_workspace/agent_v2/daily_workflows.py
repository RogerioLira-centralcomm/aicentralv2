...
WORKFLOWS = {
    ...
    "audience-map": ("Mapa de audiência", "Aprofundamento de audiências dentro do canal solicitado, com evidências e hipóteses identificadas.", "Planejamento", ("web.search", "planner.research_plan_inputs"), "Mapeie segmentos, necessidades, contextos de consumo e formatos somente dentro do canal ou dos canais explicitamente solicitados pelo usuário. Trate os canais nomeados como uma lista permitida: não introduza, compare nem recomende canais externos, salvo pedido explícito para ampliar ou comparar. Se o catálogo retornar requested_channel_scope, use-o como limite; se channels_status indicar requested_channel_not_found, informe que não há correspondência no catálogo e não substitua por outros canais. O nome da marca/projeto, por si só, não significa que seja um canal. Preserve serviços e indústrias como setores de aplicação da campanha, não como canais nem como audiências do inventário Netflix. Separe segmentos confirmados, hipóteses de planejamento e lacunas. Dados públicos exigem conteúdo de fonte efetivamente lida (read_status=read); resultado apenas descoberto é pista de pesquisa, não evidência. O catálogo do Planner é inventário de opções, não prova de tamanho, preço, disponibilidade ou desempenho. Não invente tamanho de público, demografia ou capacidade de segmentação."),
    ...
    "campaign-tracker": ("Acompanhamento de campanha", "Analisa relatórios enviados e sugere próximos passos.", "Análise", ("campaign.review_supplied_metrics",), "Analise diretamente o relatório anexado como fonte principal, sem depender do módulo Reports nem de relatórios importados. Para métricas coladas no chat, use campaign.review_supplied_metrics; seus cálculos são condicionais porque período e escopo não foram verificados. Extraia período, objetivo, canais, métricas e resultados explícitos; calcule variações somente com valores e períodos comparáveis. Separe fatos do relatório, interpretações e recomendações, cite páginas ou trechos quando disponíveis, indique lacunas e proponha próximos passos priorizados. Não invente valores nem alegue consulta a plataformas ou a relatórios do projeto. Se não houver arquivo ou métricas fornecidas na conversa, peça o material necessário."),
    "creative-concept": ("Conceito criativo", "Direção, mensagem e variações para campanha.", "Criação", (), "Entregue duas rotas criativas distintas e recomende uma com critério ligado ao objetivo. Para cada rota, explicite público/necessidade, promessa, prova disponível, mensagem central, tom, aplicação por canal e risco de interpretação. Use a identidade da marca e o projeto quando presentes; se faltar prova, substitua alegação factual por hipótese ou pergunta de validação. Preserve os canais explicitamente definidos no briefing e não acrescente outros na aplicação criativa, salvo pedido expresso de expansão. Antes de responder, revise coerência com marca, clareza, diferença real entre as rotas e alegações numéricas ou comparativas sem suporte. Não apresente essa autoavaliação como revisão independente."),
    "channel-copy": ("Copy por canal", "Textos prontos para formatos e canais escolhidos.", "Criação", (), "Produza textos prontos por canal e formato, com CTA, intenção e duas variantes quando isso ajudar a decisão. Respeite a voz da marca e diferencie mensagem confirmada de proposta criativa. Se o usuário especificar canal ou canais, escreva somente para eles; não acrescente canais, formatos ou placements de outras plataformas. Só aplique limites de caracteres fornecidos pelo usuário ou por configuração versionada; não invente regras atuais da plataforma nem afirme contagem exata sem verificação. Revise clareza, promessa, CTA e alegações factuais antes de entregar. Se nenhum canal estiver indicado, proponha um conjunto pequeno como sugestão separada."),
    ...
    "client-delivery": ("Atendimento e entregas", "Organiza status, pendências e mensagem ao cliente.", "Atendimento", ("projects.list_tasks", "projects.list_resources"), "Monte um status objetivo para o cliente com base em project_task_status e nas fontes efetivamente lidas: feito, em andamento, pendências, responsáveis e próximo contato. project_task_status conta tarefas nativas, mas tarefa concluída não comprova entrega ou aceite do cliente; não transforme recursos listados em entregas concluídas. Diferencie dados confirmados de proposta e não diga que enviou mensagem ou mudou tarefas."),
}
