    ...
    "payload": normalize_payload(
        {
            ...
            "geo": _geo(-19.630503, -43.965760, 15),
            "points": [
                _fence(
                    {
                        "id": "cnf-terminal",
    ...
    "payload": normalize_payload(
        {
            ...
            "geo": _geo(-23.625262, -46.660529, 15),
            "points": [
                _fence(
                    {
                        "id": "cgh-terminal",
    ...
    "payload": normalize_payload(
        {
            ...
            "geo": _geo(-22.912262, -43.167686, 16),
            "points": [
                _fence(
                    {
                        "id": "sdu-terminal",
    ...
    "payload": normalize_payload(
        {
            ...
            "geo": _geo(-22.814450, -43.245939, 15),
            "points": [
                _fence(
                    {
                        "id": "gig-terminal",
    ...
    "payload": normalize_payload(
        {
            ...
            "media": {"hero_url": "/static/images/places/generated/diamond-mall-hero-333a63d7.png"},
            "offer": _offer(
    ...
    "payload": normalize_payload(
        {
            ...
            "geo": _geo(-23.577199, -46.688049, 16),
            "points": [
                _fence(
                    {
                        "id": "igt-mall",
            ...
            "media": {"hero_url": "/static/images/places/generated/iguatemi-sao-paulo-hero-9dc065d4.png"},
            "offer": _offer(
    ...
    "payload": normalize_payload(
        {
            ...
            "geo": _geo(-23.586883, -46.655424, 15),
            "points": [
                _fence(
                    {
                        "id": "ibi-oca",
            ...
            "media": {"hero_url": "/static/images/places/generated/ibirapuera-hero-aa3e335b.png"},
            "offer": _offer(
    ...
    "payload": normalize_payload(
        {
            ...
            "geo": _geo(-19.930319, -43.989266, 16),
            "points": [
                _fence(
                    {
                        "id": "exp-pavilhao",
            ...
            "media": {"hero_url": "/static/images/places/generated/expominas-hero-89eaae5c.png"},
            "offer": _offer(
...
from .venues import VENUE_PLACES
