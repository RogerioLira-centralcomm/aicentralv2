...
- Quando a primeira busca do Insights não produz fonte recente e legível, uma segunda consulta pública mais ampla tenta cobrir a lacuna antes de retornar indisponibilidade. A expansão é limitada a uma busca; Radar e o motor compartilhado completo ainda precisam da mesma disciplina.
