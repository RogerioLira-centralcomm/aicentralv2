...
- O Simulador respeita os canais explicitamente mencionados. Os manifestos de Simulador e Acompanhamento foram atualizados para a versão 1.2.0 na base configurada, alinhando as ferramentas declaradas aos caminhos efetivos.
