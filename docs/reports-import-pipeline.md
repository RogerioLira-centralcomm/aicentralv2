...
Próximos blocos: revisão/confirmação dos blocos visuais com evidência por região e mapeamento assistido de cabeçalhos desconhecidos. Um arquivo real de cada plataforma é necessário para ampliar os aliases sem adivinhar o formato do export.
