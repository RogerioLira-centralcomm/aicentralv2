...
Próximos blocos: comparação explícita entre snapshots de intervalo, evidência por região do print e sugestões semânticas opcionais para cabeçalhos desconhecidos. Um arquivo real de cada plataforma é necessário para ampliar os aliases sem adivinhar o formato do export.
