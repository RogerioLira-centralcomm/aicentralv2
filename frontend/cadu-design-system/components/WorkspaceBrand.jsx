      ...
      <div className="cadu-ds-home-workarea cadu-ds-brand-workarea">
        ...
        <section className="cadu-ds-brand-content">
          ...
          <div className="cadu-ds-brand-layout">
            ...
            <BrandSignalRail brand={brand} profile={profile} fonts={fonts} colors={colors} canEdit={canEdit} onAudit={() => setDialog('audit')} notStarted={notStarted}/>
          </div>
        </section>
      </div>
    </main>
