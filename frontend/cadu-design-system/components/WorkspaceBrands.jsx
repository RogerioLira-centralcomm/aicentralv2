...
export function WorkspaceBrands({bootstrap}) {
  ...
  return <div className="cadu-ds-home-shell cadu-ds-brands-shell">
    <main className="cadu-ds-home-main">
      <WorkspaceNavbar logo={bootstrap.caduMark} solutions={solutions}><a className="cadu-ds-brands-nav" href={bootstrap.urls.projects}>Projetos</a><strong>Marcas</strong></WorkspaceNavbar>
