...
export function WorkspaceProject({bootstrap}) {
  ...
  return <div className="cadu-ds-home-shell cadu-ds-project-shell">
    <main className="cadu-ds-home-main">
      <WorkspaceNavbar className="cadu-ds-project-navbar" logo={bootstrap.caduMark} solutions={solutions} actions={<a className="cadu-ds-project-quiet-link" href={projectLinks.legacy}>Mais opções</a>}><a href={bootstrap.urls.projects}>Projetos</a><span aria-hidden="true">/</span><strong>{project.name}</strong></WorkspaceNavbar>
