...
export function WorkspaceProjects({bootstrap}) {
  ...
  return <div className="cadu-ds-home-shell cadu-ds-brands-shell cadu-ds-brands-shell--projects">
    ...
    {creating && <ProjectCreateDialog action={bootstrap.urls.createProject} csrfToken={bootstrap.csrf} onClose={() => setCreating(false)} onCreated={project => window.location.assign(project.href)}/>}
  </div>;
}
