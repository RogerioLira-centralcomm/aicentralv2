...
import {ThemeProvider, WorkspaceAccount, WorkspaceBrands, WorkspaceHome, WorkspaceLegacyChrome, WorkspaceProject, WorkspaceProjects} from '../cadu-design-system';
...
if (root && bootstrapNode) {
  try {
    ...
    const workspaceMode = bootstrap.homeMode || bootstrap.projectMode || bootstrap.brandsMode || bootstrap.projectsMode || bootstrap.accountMode || bootstrap.legacyMode;
