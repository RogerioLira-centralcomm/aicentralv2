...
class CreativeFormatLabDeskTest(unittest.TestCase):
    def test_mesa_registrada_no_shell(self):
        ...
        self.assertIn("modelagem_criativos.css') }}?v=122", desk)
        ...
        self.assertIn("Clipes gerados", (root / "aicentralv2" / "templates" / "parametros" / "_mc_video.html").read_text(encoding="utf-8"))
