...
class CreativeFormatLabDeskTest(unittest.TestCase):
    def test_mesa_registrada_no_shell(self):
        ...
        self.assertIn("modelagem_criativos.css') }}?v=120", desk)
        ...
        self.assertIn("mcTrocrWorkspaceVideo", trocar)
        self.assertIn("mcTrocrVideoPanel", trocar)
        self.assertIn("Gerar vídeo", trocar)
