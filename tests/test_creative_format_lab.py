...
class CreativeFormatLabDeskTest(unittest.TestCase):
    def test_mesa_registrada_no_shell(self):
        ...
        self.assertIn("modelagem_criativos.css') }}?v=108", desk)
        self.assertIn("mc_page_js) }}?v=69", desk)
        ...
        self.assertIn("Prompt avançado", trocar)
        ...
        self.assertIn("Usar DNA da marca", trocar)
