...
class CreativeFormatLabTest(unittest.TestCase):
    ...
    def test_campanhas_modelo_tem_quatro_cenas(self):
        ...
        self.assertEqual(
            slugs,
            {"tim-controle-ctv", "vivara-presente-ctv", "rededor-cuidado-ctv", "g1-ctv"},
        )
        for slug in slugs:
...
class CreativeFormatLabDeskTest(unittest.TestCase):
    def test_mesa_registrada_no_shell(self):
        ...
        self.assertIn("video", MC_DESKS)
        self.assertEqual(MC_DESKS["video"]["page_js"], "js/mc-cadu-video.js")
        ...
        self.assertIn("/lab/templates", rules)
        self.assertIn("/lab/templates/<slug>", rules)
        lab_js = (root / "aicentralv2" / "static" / "js" / "mc-lab-templates.js").read_text(encoding="utf-8")
        self.assertIn("/formats", lab_js)
        self.assertIn("compatible_formats", lab_js)
        lab_edit = (root / "aicentralv2" / "templates" / "parametros" / "lab" / "template_edit.html").read_text(encoding="utf-8")
        self.assertIn("mcLabFormats", lab_edit)
        self.assertIn("/lab/design-system/marca/<client_id>", rules)
        self.assertIn("/lab/design-system/campanha/<campaign_id>", rules)
        from aicentralv2.creative_modeling_routes import CADU_RETIRED_DESKS
        self.assertEqual(CADU_RETIRED_DESKS, {"extrair", "revisao", "lab"})
        shell = (root / "aicentralv2" / "templates" / "parametros" / "_mc_shell.html").read_text(encoding="utf-8")
        self.assertIn("mc-cadu-bar", shell)
        self.assertIn("mcCaduMore", shell)
        self.assertIn("Pesquisa", shell)
        self.assertNotIn("mc-desk-nav-flow", shell)
        self.assertNotIn("mc-desk-nav-lab", shell)
        self.assertNotIn("mc-chrome", shell)
        ...
        self.assertIn("mc-studio", html)
        self.assertIn("mcStudio", html)
        self.assertIn("mcStudioCase", html)
        self.assertIn("Gerar roteiro", html)
        self.assertIn("Gerar referências", html)
        self.assertIn("Montar cenas", html)
        self.assertIn("Cotar e gravar vídeo", html)
        self.assertIn("v3 recomendada", html)
        self.assertIn("Sem Trocr", html)
        self.assertIn("Editar no Trocr", html)
        self.assertIn("mcStudioTrocr", html)
        self.assertIn("mcStudioConfirm", html)
        self.assertNotIn("states", MC_DESKS)
        ...
        self.assertIn("/parametros/api/format-lab/prototype/script", js)
        self.assertIn("/parametros/api/format-lab/prototype/refs", js)
        self.assertIn("/parametros/api/format-lab/prototype/scenes", js)
        self.assertIn("/parametros/api/format-lab/prototype/video", js)
        self.assertIn("/parametros/api/format-lab/campaigns", js)
        self.assertIn("g1-ctv", js)
        self.assertIn("McDeskBrand", js)
        self.assertIn("early_exit", js)
        self.assertIn("cx-trocr-handoff", js)
        self.assertIn("from=studio", js)
        ...
        self.assertIn("Ajuste a peça", trocar)
        self.assertNotIn("mcTrocrWorkspaceVideo", trocar)
        self.assertNotIn("mcTrocrVideoPanel", (trocar_dir / "_mc_trocar.html").read_text(encoding="utf-8"))
        video_page = (trocar_dir / "_mc_video.html").read_text(encoding="utf-8")
        self.assertIn("mcVideoLibrary", video_page)
        self.assertIn("mcVideoScenes", video_page)
        self.assertIn("Gerar clipe", video_page)
        self.assertIn("mcSwapVideo", video_page)
        self.assertIn("Sequência de cenas", video_page)
        self.assertIn("O que preservar", video_page)
        ...
        self.assertIn("mcTrocrReel", trocar)
        self.assertIn("Caber na tela", trocar)
        self.assertIn("mcTrocrBrandHint", trocar)
        self.assertIn("Aplicar DNA nesta versão", trocar)
        self.assertNotIn("Marca da mesa", trocar)
        self.assertNotIn("Image 2", trocar)
        ...
        self.assertIn("openHandEdit", swap_js)
        self.assertIn("mcSwapHeadline", swap_js)
        self.assertIn("startNewRun", swap_js)
        self.assertIn("media=still", swap_js)
        self.assertIn("params.get('client')", swap_js)
        self.assertIn("mcCaduVideo", (root / "aicentralv2" / "templates" / "parametros" / "_mc_shell.html").read_text(encoding="utf-8"))
        home_js = (root / "aicentralv2" / "static" / "js" / "mc-cadu-home.js").read_text(encoding="utf-8")
        self.assertIn("client: clientId", home_js)
        self.assertIn("cadu:brand-ready", home_js)
        self.assertIn("params.set('clip'", home_js)
        library_js = (root / "aicentralv2" / "static" / "js" / "mc-studio-library.js").read_text(encoding="utf-8")
        self.assertIn("/swap/library", library_js)
        # Broken previews must retain the result and its editor link.
        ...
        self.assertIn("moveSelectedScene", video_js)
        self.assertIn("previewMode", video_js)
        self.assertIn("requestVersion", video_js)
        self.assertIn("quoteStatus", video_js)
        video_page = (root / "aicentralv2" / "templates" / "parametros" / "_mc_video.html").read_text(encoding="utf-8")
        self.assertIn("Clipe gerado", video_page)
        self.assertIn("Enviar imagem", video_page)
        self.assertIn("Remover arquivos indisponíveis", video_page)
        self.assertNotIn("Apagar 404", video_page)
        player_js = (root / "aicentralv2" / "static" / "js" / "trocr" / "animate-player.js").read_text(encoding="utf-8")
        self.assertIn(".mc-cadu-video-frame", player_js)
        ...
        self.assertIn("placeCreative", swap_js)
        self.assertIn("mcSwapVideo", swap_js)
        self.assertIn("askConfirm", swap_js)
        self.assertNotIn("window.confirm", swap_js)
        self.assertNotIn("window.prompt", swap_js)
        self.assertIn("McDeskBrand", swap_js)
        self.assertIn("applyDeskBrand", swap_js)
        self.assertIn("syncBrandOption", swap_js)
        self.assertIn("conflictCopy", swap_js)
        self.assertIn("canMarkOnImage", swap_js)
        self.assertNotIn("Image 2", swap_js)
        self.assertIn("selectBrand", swap_js)
        brand_js = (root / "aicentralv2" / "static" / "js" / "mc-desk-brand.js").read_text(encoding="utf-8")
        self.assertIn("cx-mc-desk-client", brand_js)
        self.assertIn("function hasInfo", brand_js)
        self.assertIn("function forSelect", brand_js)
