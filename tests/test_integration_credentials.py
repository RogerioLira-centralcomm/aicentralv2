...
class IntegrationCredentialsContractTest(unittest.TestCase):
    def test_migration_deploy_menu_and_ui_are_wired(self):
        ...
        self.assertIn("Dify — Cadu Chat exclusivo", template)
        self.assertIn('data-integration-form="dify_cadu_chat"', template)
        self.assertIn("Dify — integração global", template)
