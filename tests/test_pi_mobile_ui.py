...
class PiMobileUiContractTest(unittest.TestCase):
    ...
    def test_vinculos_da_cotacao_ficam_bloqueados_e_integrados_aos_contatos(self):
        ...
        self.assertIn("pi-record", pi_detail)
        self.assertIn("data-inline-open", pi_detail)
        self.assertIn("initPiInlineFields", pi_detail)
        self.assertIn(".pi-inline.is-editing", css)
