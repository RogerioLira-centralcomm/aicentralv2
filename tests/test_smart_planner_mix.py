...
class MixEngineTest(unittest.TestCase):
    ...
    def test_review_template_has_three_columns(self):
        ...
        self.assertNotIn("Mídia progressiva", html)
        self.assertIn('id="sp-mix-balance-content"', html)
        self.assertIn('id="sp-mix-single"', html)
        self.assertIn("Todos os métodos", html)
        ...
        self.assertIn("Duas análises, uma decisão comercial", guide)
        self.assertIn("Leitura do briefing", guide)
        self.assertIn("Análise da estratégia", guide)
        self.assertIn("pontos de OOH", guide)
        self.assertIn("revisão final", guide)
