...
class WorkspaceDockTest(TestCase):
    ...
    @mock.patch('aicentralv2.services.integration_credentials.resolve_typesafe_api_key')
    @mock.patch('aicentralv2.services.typesafe_service.system_one')
    def test_home_resume_suggestion_uses_local_recency_without_external_ai(self, system_one, api_key, candidates):
        ...
        self.assertEqual(response.json['source'], 'recent')
